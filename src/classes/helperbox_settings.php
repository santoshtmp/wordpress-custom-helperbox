...
if (! class_exists('helperbox_settings')) {

    /**
     * helperbox_settings
     */
    class helperbox_settings {

        public static $admin_page_slug = "helperbox";
        ...
        function __construct() {
            ...
            add_action('admin_menu', [$this, 'helperbox_settings_submenu']);
        }
        ...
        function helperbox_settings_init() {
            // Sanitize the character limit as an integer
            register_setting('helperbox_settings_group', 'ptreq_character_limit', [
                'type' => 'integer',
            ...
            register_setting('helperbox_settings_group', 'ptreq_post_types', [
                'type' => 'array',
        ...
        function helperbox_settings_submenu() {
            add_options_page(
                'Helperbox Settings', // Page title.
                'Helperbox Settings', // Menu title.
                'manage_options',     // Capability required to see the menu.
                self::$admin_page_slug, // Menu slug.
                [$this, 'helperbox_setting_page_callback'] // Function to display the page content.
            );
        }
         ...
         */
        function helperbox_setting_page_callback() {
